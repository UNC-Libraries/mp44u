...
public class FormatTransformationIT {
    ...
    public void testAudioEncodeMp3() throws Exception {
        ...
        Path outputFile = audioService.ffmpegEncodeToM4a(options, EncodingOperation.ENCODE, false);
    ...
    public void testAudioCopyAac() throws Exception {
        ...
        Path outputFile = audioService.ffmpegEncodeToM4a(options, EncodingOperation.COPY, false);
    ...
    public void testAudioEncodeAu() throws Exception {
        ...
        Path outputFile = audioService.ffmpegEncodeToM4a(options, EncodingOperation.ENCODE, true);
    ...
    public void testVideoCopyMp4() throws Exception {
        ...
        Path outputFile = videoService.ffmpegEncodeToMp4(options, EncodingOperation.COPY, EncodingOperation.COPY,
                AVInfoService.Subtitles.SUBTITLES, true, false);
    ...
    public void testVideoEncodeMts() throws Exception {
        ...
        options.setSourceFormat("video/m2ts");
